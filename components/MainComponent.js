...
const MenuNavigator = createStackNavigator( 
    ...
    {
        initialRouteName: 'Menu', // to start this StackNavigator with Menu as the first screen 
        navigationOptions: { 
            headerStyle: { 
...
const HomeNavigator = createStackNavigator( 
    ...
    {
        // don't need initialRouteName here cause we have only one screen
...
class Main extends React.Component {
    ...
    componentDidMount() {
        ...
        NetInfo.fetch() 
            .then(connectionInfo => {
                if (Platform.OS === 'ios') {
                    alert('Initial Network Connectivity Type: '+ connectionInfo.type + ', effectiveType: ' + connectionInfo.effectiveType); 
                }
                else
                    ToastAndroid.show(
                        'Initial Network Connectivity Type: '+ connectionInfo.type + ', effectiveType: ' + connectionInfo.effectiveType, ToastAndroid.LONG); 
            });

        const returnedFunction = NetInfo.addEventListener(this.handleConnectivityChange); 
        this.setState({ unsubscribe: returnedFunction }) 
    }
